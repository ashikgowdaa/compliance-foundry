...
export default function TestimonialCard({item}:{item:testimonialCard}) {
  return (
  <>
  <Flex className=" border-[1px] border-gray-200 rounded-lg p-2 bg-[#F3F5FA] w-96  text-text-tertiary"  justify="between">
   <Flex className="w-[25%]" >
    <img src={imageGenerationUrl(item.authorImage.url)}  className="rounded-full w-[60px] h-[60px] " alt="no image" />
   </Flex>
